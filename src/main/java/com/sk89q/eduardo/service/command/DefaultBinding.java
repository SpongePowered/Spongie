...
public class DefaultBinding extends BindingHelper {
    ...
    @BindingMatch(type = CommandLocals.class, behavior = BindingBehavior.PROVIDES, consumedCount = -1)
    public CommandLocals getLocals(ArgumentStack context) throws ParameterException {
        return context.getContext().getLocals();
    }
